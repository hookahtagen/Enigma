...
def main(file: str, password: str, mode: str):
    
    enc_file = file.replace('.txt', '.enc')
    
    with open(file, 'rb') as in_file, open(enc_file, 'wb') as out_file:
        encrypt(in_file, out_file, password)

    with open(enc_file, 'rb') as in_file, open(file, 'wb') as out_file:
